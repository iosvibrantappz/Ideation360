...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MMCollapsibleLabel/MMCollapsibleLabel.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/TCBlobDownload/TCBlobDownload.framework"
